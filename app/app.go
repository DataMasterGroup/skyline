...
import (
	...
	appparams "github.com/DataMasterGroup/skyline/app/params"
	"github.com/DataMasterGroup/skyline/x/skyline"
	skylinekeeper "github.com/DataMasterGroup/skyline/x/skyline/keeper"
	skylinetypes "github.com/DataMasterGroup/skyline/x/skyline/types"
...
var (
	...
	DefaultNodeHome = func(appName string) string {
		return os.ExpandEnv(fmt.Sprintf("$HOME/.%s", appName))
	}
...
type App struct {
	*baseapp.BaseApp
	...
	skylineKeeper skylinekeeper.Keeper
...
func New(
	...
	app.skylineKeeper = *skylinekeeper.NewKeeper(
		appCodec, keys[skylinetypes.StoreKey], keys[skylinetypes.MemStoreKey],
	)
	...
	app.mm = module.NewManager(
		...
		transferModule,
		skyline.NewAppModule(appCodec, app.skylineKeeper),
